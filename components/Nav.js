...
export default function Nav({show}) {
    ...
    const activeLink = inactiveLink+ ' bg-white text-primary rounded-lg ';
    ...
    return(
        <aside className={(show?'left-0':'-left-full')+ " top-0 p-4 fixed w-full bg-primary2 h-full md:static md:w-auto transition-all"}>
        ...
        {/* <button onClick={() => { signOut('google')}} className=" p-2 px-4 rounded-lg">
    Logout
       </button> */}
